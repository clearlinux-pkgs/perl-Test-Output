...
cp %{_builddir}/Test-Output-1.033/LICENSE %{buildroot}/usr/share/package-licenses/perl-Test-Output/46ff8d6b70f1daa7d3b90d4d9f497b4c0bca0b67
if test -f Makefile.PL; then
...
%files perl
%defattr(-,root,root,-)
/usr/lib/perl5/vendor_perl/5.34.0/Test/Output.pm
